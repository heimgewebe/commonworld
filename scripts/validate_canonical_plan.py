...
REQUIRED_PLAN_TOKENS = (
    ...
    "begrenzte statische No-JavaScript-Einstiegsseite bleibt genau einmal",
...
EXPECTED_SCRIPT_FILES = {
    ...
    "smoke_catalog_hierarchy_v2_browser.mjs",
    "smoke_focus_overlay_browser.mjs",
    "smoke_locale_candidates_browser.mjs",
    "render_public_shell.py",
    "proposal_i18n.py",
    "proposal_runtime_i18n.py",
    "public_cache.py",
    "refresh_catalog_evidence.py",
    ...
    "validate_catalog_recovery.py",
    "validate_catalog_hierarchy_v2.py",
...
EXPECTED_TEST_FILES = {
    ...
    "test_catalog_hierarchy_v2.py",
    "test_catalog_hierarchy_v2_evidence.py",
    "test_catalog_platform.py",
    "test_catalog_scale_fixtures.py",
    ...
    "test_refresh_catalog_evidence.py",
