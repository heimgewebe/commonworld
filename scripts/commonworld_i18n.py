...
SHELL_REPLACEMENTS_EN = {
    ...
    '<option value="auto">Automatisch</option>': '<option value="auto">Automatic</option>',
    ...
    'Automatisch: Suchtreffer nach Passung, mit Standort nach Nähe, sonst stabile Katalogreihenfolge.': 'Automatic: search results by relevance, with a location by proximity, otherwise the stable catalogue order.',
