      ...
      <form id="commons-proposal-form" class="proposal-form" novalidate>
        ...
        <fieldset>
          ...
          <div class="proposal-grid">
            ...
            <label><span>Präsenz</span><select name="presence_kind" required><option value="">Bitte wählen</option><option value="geographic">Geografisch</option><option value="digital">Digital</option><option value="hybrid">Hybrid</option></select></label>
          </div>
          <label><span>Grobe Region oder Ort</span><input name="region" type="text" minlength="2" maxlength="120" required placeholder="z. B. Uruguay, Taiwan oder Aotearoa Neuseeland" aria-describedby="region-help" /><small id="region-help">Nur Land, Großregion oder öffentlich unproblematische Stadt. Keine Adresse oder Koordinate.</small></label>
          <label class="check-row"><input name="sensitive_location_risk" type="checkbox" /><span>Der Vorschlag betrifft möglicherweise private oder sensible Orte. Die Redaktion soll die Ortsangabe besonders streng prüfen.</span></label>
        </fieldset>
