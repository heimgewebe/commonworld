...
validate-release-snapshot-lifecycle:
	python3 scripts/validate_release_snapshot_lifecycle.py

validate: validate-cache-coherence validate-release-snapshot-lifecycle validate-security-policy validate-proposal-path validate-current-state validate-platform-foundation validate-canonical-plan validate-contracts validate-locale-release validate-commons-admission validate-semantic-zoom validate-visual-semantics validate-renderer-spike validate-maplibre-phase2-proof validate-device-acceptance-pack validate-device-acceptance-rerun validate-digital-sphere validate-digital-ring-taxonomy validate-layered-digital-sphere-proof validate-digital-sphere-real-surface validate-device-acceptance-performance-v4 validate-physical-device-acceptance-v4-apple validate-public-catalog validate-public-seed-baseline validate-presence-axes validate-intent-search-discovery validate-renderer-selection validate-public-maplibre-vertical-slice validate-production-delivery-provider validate-public-shell validate-catalog-delivery-budget validate-catalog-browser-measurement-decision validate-catalog-scale-gates validate-catalog-hierarchy-v2 test-js test
...
validate-catalog-hierarchy-v2:
	python3 scripts/validate_catalog_hierarchy_browser_v2.py
	python3 scripts/validate_catalog_hierarchy_v2.py
	python3 -m unittest tests.test_catalog_hierarchy_v2 tests.test_catalog_hierarchy_v2_evidence tests.test_catalog_hierarchy_browser_v2_evidence

browser-smoke-catalog-hierarchy-v2: build
	npm run smoke:catalog-hierarchy
