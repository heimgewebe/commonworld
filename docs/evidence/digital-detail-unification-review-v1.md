...
- Self-review found one browser contract that still required the obsolete automatic child-lane jump. The contract now proves the canonical behavior instead: the root or parent lane remains unchanged while the shared `#project-focus` opens above it.
