...
Die revisionsgebundene Skalierungsprobe vom 27. Juli 2026 macht 1.000 und 10.000 Einträge zu den verbindlichen synthetischen Vor-Cutover-Stufen. Bereits der vollständige 1.000er-Weltindex überschreitet mit 62.845 Byte gzip das 32.768-Byte-Startbudget; bei 10.000 Einträgen erreicht er 624.128 Byte gzip. Beide Vollindizes bleiben deshalb Export- und Prüfartefakte, während die größten bedarfsgeladenen Shards mit 1.036 beziehungsweise 4.231 Byte gzip deutlich unter der Warnschwelle bleiben.

Der 100.000-Einträge-Stresstest erreicht 6.237.810 Byte gzip für den Vollindex und 28.683 Byte gzip für den größten von 256 Shards. Damit liegt er elf Byte über der Shard-Warnschwelle von 28.672 Byte, aber noch unter dem harten Maximum von 32.768 Byte. Vor weiterem Wachstum ist deshalb eine kompatible Präfixtiefen-Migration zu belegen; daraus folgt weder 100.000er-Produktionsreife noch eine Backend-, PostGIS- oder PMTiles-Pflicht ohne gemessenen statischen Engpass. Der ausführbare Vor-Cutover-Vertrag liegt in `contracts/commonworld/catalog-scale-gates.contract.json`.
