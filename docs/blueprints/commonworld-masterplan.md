...
Die revisionsgebundene, schema-realistische Skalierungsprobe vom 2. August 2026 macht 1.000 und 10.000 Einträge zu den verbindlichen Vor-Cutover-Stufen. Bereits der vollständige 1.000er-Weltindex überschreitet mit 100.426 Byte gzip das 32.768-Byte-Startbudget; bei 10.000 Einträgen erreicht er 995.427 Byte gzip. Beide Vollindizes bleiben deshalb Export- und Prüfartefakte, während die größten bedarfsgeladenen 2-Hex-Shards mit 1.885 beziehungsweise 6.408 Byte gzip deutlich unter der Warnschwelle bleiben. Die Fixtures werden aus dem aktuellen CommonProject-Katalog abgeleitet, erneut gegen Schema v4 geprüft und binden Ortsmodi, Präsenzformen, Relationen, Provenienz, deutsche und englische Texte sowie inhaltsadressierte Details.

Der kompakte 100.000-Einträge-Stresstest erreicht 9.810.673 Byte gzip für den Vollindex und 39.531 Byte gzip für den größten von 256 2-Hex-Shards. Damit überschreitet er das harte Maximum von 32.768 Byte und hält den aktuellen Runtimepfad fail-closed. Eine 3-Hex-Neupartitionierung senkt den größten Shard auf 5.035 Byte, erzeugt in der flachen Vertragsform jedoch 212.444 Byte gzip Manifest und 286.343 Byte gzip Aggregat. Vor diesem Wachstum ist deshalb ein versionierter hierarchischer Manifest- und Aggregatvertrag samt Kompatibilitäts-, Recovery- und Browserbelegen umzusetzen; daraus folgt weder 100.000er-Produktionsreife noch eine Backend-, PostGIS- oder PMTiles-Pflicht ohne gemessenen statischen Engpass. Der ausführbare Vor-Cutover-Vertrag liegt in `contracts/commonworld/catalog-scale-gates.contract.json`.
