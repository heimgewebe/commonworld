...
class PublicShellTests(unittest.TestCase):
    ...
    def test_final_digital_lane_uses_inline_common_details(self) -> None:
        ...
        self.assertIn("project-detail-grid", app)
        self.assertIn("project-detail-section", app)
        self.assertIn("back_to_bundle", app)
        ...
        self.assertIn(".project-detail-grid", css)
        self.assertIn(".project-detail-section", css)
