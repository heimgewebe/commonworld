...
from scripts.validate_real_hybrid_commons import ROOT, validate_real_hybrid_commons


class RealHybridCommonsTests(unittest.TestCase):
    ...
    def test_real_hybrid_slice_validates(self) -> None:
        self.assertEqual([], validate_real_hybrid_commons(ROOT))
