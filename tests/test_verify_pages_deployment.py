...
class PagesDeploymentReadbackTests(unittest.TestCase):
    ...
    def test_workflow_uses_minimal_read_permissions_and_always_uploads_receipt(self) -> None:
        ...
        self.assertIn("actions/checkout@3d3c42e5aac5ba805825da76410c181273ba90b1", validation_workflow)
        self.assertIn("actions/setup-python@5fda3b95a4ea91299a34e894583c3862153e4b97", validation_workflow)
        self.assertIn("actions/setup-node@820762786026740c76f36085b0efc47a31fe5020", validation_workflow)
