...
```text
commonworld = discovery and public understanding
weltgewebe  = proposal, participation, coordination and administration
```

Commonworld stays readable without an account and does not create a second administration truth.
...
- Preserve search, filter, camera and focus context.
- Maintain an equivalent linear view.
- Derive visual projections from canonical catalog data.

## Safety rules

- No fixture may appear as a real public Commons.
- Preserve provenance, freshness and location privacy.
- Imports create candidates, never automatic publication.
- No public write path, account system or project administration in commonworld.
