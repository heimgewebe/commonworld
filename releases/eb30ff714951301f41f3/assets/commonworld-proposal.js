import { WAVE1_LOCALES, normalizeKnownLocale } from './commonworld-locale-registry.mjs?v=86ed3c4ded91';
...
if (WAVE1_LOCALES.includes(ACTIVE_LOCALE)) {
  let timeoutId = null;
  try {
    const importPromise = import('./commonworld-wave1-locales.mjs?v=52b4c4ea480a');
