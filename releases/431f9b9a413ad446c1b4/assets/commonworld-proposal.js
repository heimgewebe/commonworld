import { WAVE1_LOCALES, normalizeKnownLocale } from './commonworld-locale-registry.mjs?v=20ad6de1cfac';
...
if (WAVE1_LOCALES.includes(ACTIVE_LOCALE)) {
  let timeoutId = null;
  try {
    const importPromise = import('./commonworld-wave1-locales.mjs?v=d9db353b5711');
