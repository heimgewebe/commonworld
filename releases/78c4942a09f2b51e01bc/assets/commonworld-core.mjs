import { COMMONWORLD_EN_LOCALE } from './commonworld-en-locale.mjs?v=5de321897b5d';
import { FALLBACK_LOCALE, normalizeLocale } from './commonworld-i18n.mjs?v=196667f2d9af';
