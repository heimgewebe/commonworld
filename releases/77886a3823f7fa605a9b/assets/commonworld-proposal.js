import { WAVE1_LOCALES, normalizeKnownLocale } from './commonworld-locale-registry.mjs?v=165a78a0e1f2';
...
if (WAVE1_LOCALES.includes(ACTIVE_LOCALE)) {
  let timeoutId = null;
  try {
    const importPromise = import('./commonworld-wave1-locales.mjs?v=9cf76571ec84');
