import { COMMONWORLD_EN_LOCALE } from './commonworld-en-locale.mjs?v=a1d2bc56dfd4';
import {
  CANDIDATE_LOCALES,
  DEFAULT_LOCALE,
  FALLBACK_LOCALE,
...
} from './commonworld-locale-registry.mjs?v=6658799570ff';
...
if (shouldLoadWave1LocalePack(runtimeDocumentLocale)) {
  ({ WAVE1_LOCALE_PACKS } = await import('./commonworld-wave1-locales.mjs?v=20670276ecab'));
}
