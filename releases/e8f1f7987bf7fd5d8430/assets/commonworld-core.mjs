import { COMMONWORLD_EN_LOCALE } from './commonworld-en-locale.mjs?v=5cff5dac2309';
import { FALLBACK_LOCALE, normalizeLocale } from './commonworld-i18n.mjs?v=c94cf9785a03';
