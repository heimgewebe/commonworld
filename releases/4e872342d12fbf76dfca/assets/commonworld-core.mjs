import { COMMONWORLD_EN_LOCALE } from './commonworld-en-locale.mjs?v=b70e7b47c539';
import { FALLBACK_LOCALE, normalizeLocale } from './commonworld-i18n.mjs?v=ea7e6f62f9c0';
