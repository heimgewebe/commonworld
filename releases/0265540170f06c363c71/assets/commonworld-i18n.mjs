import { COMMONWORLD_EN_LOCALE } from './commonworld-en-locale.mjs?v=cf5f2a864d80';
import {
  CANDIDATE_LOCALES,
  DEFAULT_LOCALE,
  FALLBACK_LOCALE,
...
} from './commonworld-locale-registry.mjs?v=8e456cc3c543';
...
export async function loadWave1LocalePacks({
  importer = () => import('./commonworld-wave1-locales.mjs?v=25d2b47805a6'),
