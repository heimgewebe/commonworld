import { COMMONWORLD_EN_LOCALE } from './commonworld-en-locale.mjs?v=9b54031431a8';
import {
  CANDIDATE_LOCALES,
  DEFAULT_LOCALE,
  FALLBACK_LOCALE,
...
} from './commonworld-locale-registry.mjs?v=9e658bb7faaa';
...
export async function loadWave1LocalePacks({
  importer = () => import('./commonworld-wave1-locales.mjs?v=577e159db602'),
