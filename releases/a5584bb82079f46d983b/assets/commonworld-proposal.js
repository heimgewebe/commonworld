import { WAVE1_LOCALES, normalizeKnownLocale } from './commonworld-locale-registry.mjs?v=9e658bb7faaa';
...
if (WAVE1_LOCALES.includes(ACTIVE_LOCALE)) {
  let timeoutId = null;
  try {
    const importPromise = import('./commonworld-wave1-locales.mjs?v=ca83b474b950');
